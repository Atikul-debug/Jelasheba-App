...
class _HealthScreenState extends State<HealthScreen> {
  ...
  final List<Hospital> _hospitals = [
    ...
    Hospital(id: '2', name: 'Shahzadpur UHC', nameBn: 'শাহজাদপুর উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'শাহজাদপুর, সিরাজগঞ্জ', phone: '07524-56231', bedCount: 50, hasEmergency: true, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'শিশু', 'দন্ত'], latitude: 24.1833, longitude: 89.5917),
    Hospital(id: '3', name: 'Ullapara UHC', nameBn: 'উল্লাপাড়া উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'উল্লাপাড়া, সিরাজগঞ্জ', phone: '07525-56124', bedCount: 50, hasEmergency: true, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'শিশু'], latitude: 24.3167, longitude: 89.5500),
    Hospital(id: '4', name: 'Kazipur UHC', nameBn: 'কাজীপুর উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'কাজীপুর, সিরাজগঞ্জ', phone: '07527-56012', bedCount: 31, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি', 'শিশু'], latitude: 24.6333, longitude: 89.6167),
    Hospital(id: '5', name: 'Belkuchi UHC', nameBn: 'বেলকুচি উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'বেলকুচি, সিরাজগঞ্জ', phone: '07526-56087', bedCount: 31, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.3700, longitude: 89.6800),
    Hospital(id: '6', name: 'Tarash UHC', nameBn: 'তাড়াশ উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'তাড়াশ, সিরাজগঞ্জ', phone: '07528-56034', bedCount: 31, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.2600, longitude: 89.4600),
    Hospital(id: '7', name: 'Kamarkhanda UHC', nameBn: 'কামারখন্দ উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'কামারখন্দ, সিরাজগঞ্জ', phone: '07529-56045', bedCount: 31, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.3500, longitude: 89.5833),
    Hospital(id: '8', name: 'Raiganj UHC', nameBn: 'রায়গঞ্জ উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'রায়গঞ্জ, সিরাজগঞ্জ', phone: '07523-56078', bedCount: 31, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.2700, longitude: 89.5200),
    Hospital(id: '9', name: 'Chauhali UHC', nameBn: 'চৌহালী উপজেলা স্বাস্থ্য কমপ্লেক্স', type: 'government', address: 'চৌহালী, সিরাজগঞ্জ', phone: '07522-56056', bedCount: 20, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.3833, longitude: 89.7500),
    Hospital(id: '10', name: 'MCWC Sirajganj', nameBn: 'মা ও শিশু কল্যাণ কেন্দ্র, সিরাজগঞ্জ', type: 'government', address: 'সিরাজগঞ্জ সদর', phone: '0751-62456', bedCount: 20, hasEmergency: false, departments: ['গাইনি ও প্রসূতি', 'শিশু', 'পরিবার পরিকল্পনা'], latitude: 24.4530, longitude: 89.7010),
    Hospital(id: '11', name: 'Sirajganj Eye Hospital', nameBn: 'সিরাজগঞ্জ চক্ষু হাসপাতাল', type: 'government', address: 'হায়দার কমপ্লেক্স, রেলগেট, সিরাজগঞ্জ সদর', phone: '01711-181858', bedCount: 20, hasEmergency: false, departments: ['চক্ষু চিকিৎসা', 'চক্ষু সার্জারি'], latitude: 24.4538, longitude: 89.6998),
    // ===== বেসরকারি হাসপাতাল =====
    ...
    Hospital(id: '13', name: 'Shaheed M. Monsur Ali Medical College Hospital', nameBn: 'শহীদ এম মনসুর আলী মেডিকেল কলেজ হাসপাতাল', type: 'private', address: 'সিরাজগঞ্জ সদর, সিরাজগঞ্জ', phone: '01556-776540', bedCount: 250, hasEmergency: true, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'শিশু', 'অর্থোপেডিক', 'কার্ডিওলজি', 'নিউরোলজি', 'চক্ষু', 'নাক-কান-গলা', 'ICU'], latitude: 24.4545, longitude: 89.7010),
    Hospital(id: '14', name: 'North Bengal Medical College Hospital', nameBn: 'নর্থ বেঙ্গল মেডিকেল কলেজ ও হাসপাতাল', type: 'private', address: 'জে সি রোড, ধানবান্দি, সিরাজগঞ্জ-৬৭০০', phone: '0751-62633', bedCount: 200, hasEmergency: true, departments: ['কার্ডিওলজি', 'অর্থোপেডিক', 'শিশু ও নবজাতক', 'গাইনি ও প্রসূতি', 'নাক-কান-গলা', 'ডেন্টাল', 'মেডিসিন', 'ডায়াবেটিস'], latitude: 24.4550, longitude: 89.6980),
    Hospital(id: '15', name: 'Avicenna Hospital Ltd.', nameBn: 'আভিসিনা হাসপাতাল লিমিটেড', type: 'private', address: 'মুজিব রোড, বড় গোলপট্টি, সিরাজগঞ্জ', phone: '01711-333301', bedCount: 100, hasEmergency: true, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'কার্ডিওলজি', 'বক্ষব্যাধি', 'প্লাস্টিক সার্জারি'], latitude: 24.4525, longitude: 89.6985),
    Hospital(id: '16', name: 'Sirajganj Community Hospital', nameBn: 'সিরাজগঞ্জ কমিউনিটি হাসপাতাল', type: 'private', address: 'মুজিব রোড, সিরাজগঞ্জ', phone: '01717-821697', bedCount: 50, hasEmergency: true, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'শিশু'], latitude: 24.4528, longitude: 89.6990),
    Hospital(id: '17', name: 'Medinova Hospital Complex', nameBn: 'মেডিনোভা হাসপাতাল কমপ্লেক্স', type: 'private', address: 'দরগাহ রোড, সিরাজগঞ্জ', phone: '01751-627300', bedCount: 50, hasEmergency: false, departments: ['মেডিসিন', 'সার্জারি', 'গাইনি ও প্রসূতি', 'ডায়াগনস্টিক'], latitude: 24.4530, longitude: 89.6975),
    Hospital(id: '18', name: 'Prime Hospital', nameBn: 'প্রাইম হাসপাতাল', type: 'private', address: 'সিরাজগঞ্জ সদর', phone: '01739-686676', bedCount: 30, hasEmergency: false, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.4535, longitude: 89.7005),
    Hospital(id: '19', name: 'Unique Hospital & Diagnostic', nameBn: 'ইউনিক হাসপাতাল ও ডায়াগনস্টিক সেন্টার', type: 'private', address: 'এম এ মতিন রোড, সিরাজগঞ্জ', phone: '01716-266352', bedCount: 30, hasEmergency: false, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি', 'ডায়াগনস্টিক'], latitude: 24.4520, longitude: 89.7015),
    Hospital(id: '20', name: 'Sheba General Hospital Ullapara', nameBn: 'শেবা জেনারেল হাসপাতাল, উল্লাপাড়া', type: 'private', address: 'এস এন কমপ্লেক্স, উল্লাপাড়া, সিরাজগঞ্জ', phone: '01730-190759', bedCount: 30, hasEmergency: true, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি', 'শিশু'], latitude: 24.3170, longitude: 89.5505),
    Hospital(id: '21', name: 'Health Care Hospital Hatikumrul', nameBn: 'হেলথ কেয়ার হাসপাতাল, হাটিকুমরুল', type: 'private', address: 'সিরাজগঞ্জ রোড, হাটিকুমরুল', phone: '01723-805642', bedCount: 25, hasEmergency: false, departments: ['মেডিসিন', 'গাইনি ও প্রসূতি'], latitude: 24.3500, longitude: 89.5840),
  ];
