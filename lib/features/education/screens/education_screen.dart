...
class _EducationScreenState extends State<EducationScreen> {
  ...
  final List<EducationInstitution> _institutions = [
    EducationInstitution(id: '1', name: 'Sirajganj Govt. Primary School', nameBn: 'সিরাজগঞ্জ সরকারি প্রাথমিক বিদ্যালয়', type: 'primary', typeBn: 'প্রাথমিক', address: 'সদর, সিরাজগঞ্জ', phone: '01711-700001', principalName: 'মোঃ আমিনুল ইসলাম', eiin: '120001', mpoStatus: 'সরকারি', studentCount: 500, teacherCount: 14),
    EducationInstitution(id: '2', name: 'Sirajganj Govt. High School', nameBn: 'সিরাজগঞ্জ সরকারি উচ্চ বিদ্যালয়', type: 'secondary', typeBn: 'মাধ্যমিক', address: 'স্কুল রোড, সিরাজগঞ্জ সদর', phone: '01711-700002', principalName: 'মোঃ ফজলুল হক', eiin: '120002', mpoStatus: 'সরকারি', studentCount: 1500, teacherCount: 50),
    EducationInstitution(id: '3', name: 'Sirajganj Govt. Girls High School', nameBn: 'সিরাজগঞ্জ সরকারি বালিকা উচ্চ বিদ্যালয়', type: 'secondary', typeBn: 'মাধ্যমিক', address: 'কলেজ রোড, সিরাজগঞ্জ', phone: '01711-700003', principalName: 'মোসাঃ ফাতেমা বেগম', eiin: '120003', mpoStatus: 'সরকারি', studentCount: 1200, teacherCount: 40),
    EducationInstitution(id: '4', name: 'Sirajganj Govt. College', nameBn: 'সিরাজগঞ্জ সরকারি কলেজ', type: 'college', typeBn: 'কলেজ', address: 'কলেজ রোড, সিরাজগঞ্জ', phone: '01711-700004', principalName: 'প্রফেসর মোঃ আলী আকবর', eiin: '120004', mpoStatus: 'সরকারি', studentCount: 4000, teacherCount: 90),
    EducationInstitution(id: '5', name: 'Islamia Madrasa Sirajganj', nameBn: 'ইসলামিয়া মাদ্রাসা সিরাজগঞ্জ', type: 'madrasa', typeBn: 'মাদ্রাসা', address: 'মাদ্রাসা রোড, সিরাজগঞ্জ', phone: '01711-700005', principalName: 'মাওলানা আব্দুর রহমান', eiin: '120005', mpoStatus: 'MPO', studentCount: 800, teacherCount: 30),
    EducationInstitution(id: '6', name: 'Sirajganj Polytechnic Institute', nameBn: 'সিরাজগঞ্জ পলিটেকনিক ইনস্টিটিউট', type: 'technical', typeBn: 'কারিগরি', address: 'ইন্ডাস্ট্রিয়াল এরিয়া, সিরাজগঞ্জ', phone: '01711-700006', principalName: 'মোঃ ইকবাল হোসেন', eiin: '120006', mpoStatus: 'সরকারি', studentCount: 600, teacherCount: 25),
  ];
